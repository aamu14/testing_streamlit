...
2. Pendidikan dan Luas Daerah:  Tingkat TK/RA memiliki korelasi positif yang cukup kuat dengan luas daerah (0.652824), menandakan bahwa dengan bertambahnya luas daerah, tingkat TK/RA cenderung naik. Korelasi positif yang lebih rendah terlihat pada tingkat SD/MI (0.392130), tingkat SMP/MTs (0.366869), dan tingkat SMA/SMK/MA (0.247176).
